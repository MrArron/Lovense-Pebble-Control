...
// app_message_open()'s platform maximum. Everything here is a handful of
// short strings and ints - the biggest single message is three hex color
// strings (~9 chars each) plus their dictionary overhead, well under 128
// bytes. This frees up heap that _size_maximum() would otherwise reserve.
